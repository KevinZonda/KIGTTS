...
internal fun LedSubtitleFloatingInputPreview(
    ...
    QuickSubtitleFloatingInputPreviewOverlay(
        ...
        startPadding = 64.dp + displayCutoutPadding.calculateStartPadding(layoutDirection),
        endPadding = 64.dp + displayCutoutPadding.calculateEndPadding(layoutDirection),
